...
public final class NotificationBinding implements ViewBinding {
  ...
  private NotificationBinding(@NonNull ConstraintLayout rootView,
      @NonNull BottomNavigationView bottomNavigation, @NonNull RecyclerView rvNotification,
      @NonNull TextView tvNotificationHeading) {
    this.rootView = rootView;
    this.bottomNavigation = bottomNavigation;
    this.rvNotification = rvNotification;
    this.tvNotificationHeading = tvNotificationHeading;
  }
  ...
  public static NotificationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tvNotificationHeading;
      TextView tvNotificationHeading = ViewBindings.findChildViewById(rootView, id);
      if (tvNotificationHeading == null) {
        break missingId;
      }

      return new NotificationBinding((ConstraintLayout) rootView, bottomNavigation, rvNotification,
          tvNotificationHeading);
    }
