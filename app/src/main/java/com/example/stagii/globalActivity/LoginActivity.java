...
public class LoginActivity  extends  AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userList.add(new User(5, "Mouhamed  Sghaier ALoui", "alouisghair@gmail.com" , "NomEmma", "PrenomEmma", "Section5", "Specialite5", "50303224", "Address5"));
    ...
    private void showAlert(String message, int color) {
        ...
        builder.setMessage(message)
                .setPositiveButton("OK", (dialog, which) -> {
                    ...
                    Intent intent = new Intent(this, StudentAcceuil.class);
